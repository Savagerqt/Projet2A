...
\cvname{Tanguy VIVIER} % Your name
\cvjobtitle{Civil Engineer, \\ Mines de Nancy} % Job title/career

\cvdate{20 December 1996} % Date of birth
\cvaddress{France} % Short address/location, use \newline if more than 1 line is required
\cvnumberphone{06 33 05 90 61} % Phone number
\cvmail{tanguy.viv@gmail.com} % Email address
